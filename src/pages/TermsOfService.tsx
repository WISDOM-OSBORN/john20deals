  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      ...
      <div className="prose prose-slate max-w-none">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-4">2. Use of the Site</h2>
          <p className="text-slate-600 dark:text-slate-400 mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-4">3. Products and Pricing</h2>
          <p className="text-slate-600 dark:text-slate-400 mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-4">4. Orders and Payment</h2>
          <p className="text-slate-600 dark:text-slate-400 mb-4">
