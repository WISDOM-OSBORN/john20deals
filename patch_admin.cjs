...
// 1. imports - Add some new icons if needed, or we probably already have them
content = content.replace(
  "import { Package, Users, ShoppingBag, Plus, Trash2, Edit, TrendingUp, DollarSign, Archive, Mail, Send, Bell, Filter, Search, X, Calendar, Upload, Info, Camera, LogOut } from 'lucide-react';",
  "import { Package, Users, ShoppingBag, Plus, Trash2, Edit, TrendingUp, DollarSign, Archive, Mail, Send, Bell, Filter, Search, X, Calendar, Upload, Info, Camera, LogOut, RefreshCw, CheckCircle, XCircle } from 'lucide-react';"
);
...
content = content.replace(
  ...
  `<button
                  ...
                  className={\`w-full flex items-center gap-3 px-4 py-3 rounded-xl transition-all \${
                    activeTab === 'swaps' 
                      ? 'bg-blue-50 text-blue-700 dark:bg-blue-900/50 dark:text-blue-400 font-bold' 
                ...
                >
                  ...
                  {swapRequests.filter(s => s.status === 'pending').length > 0 && (
                    <span className="ml-auto bg-blue-100 dark:bg-blue-900 text-blue-600 dark:text-blue-400 py-0.5 px-2 rounded-full text-xs font-bold">
