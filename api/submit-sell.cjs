...
var submit_sell_exports = {};
__export(submit_sell_exports, {
  default: () => submit_sell_default
});
module.exports = __toCommonJS(submit_sell_exports);
...
var handler = async (event) => {
  ...
  try {
    ...
    const offerPrice = expectedPrice != null && expectedPrice !== "" && !isNaN(Number(expectedPrice)) ? Number(expectedPrice) : null;
    const { supabaseUrl, supabaseKey } = getSupabaseConfig();
